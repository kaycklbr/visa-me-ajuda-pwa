            ...
            <Content style={{display: 'flex', justifyContent: 'center'}}>
              <MobileFrame>
                ...
                <div style={{margin: '.75rem', marginTop: '1rem'}}>
                  ...
                  <Card onClick={()=>navigate('/step')} image={'https://img.freepik.com/vetores-premium/ilustracao-de-icone-de-aviao-de-ar_138676-278.jpg'} title={'Fazendo programa'} subtitle={'Testando descrição do programa'} />
                  <Card onClick={()=>navigate('/step')} image={'https://img.freepik.com/vetores-premium/ilustracao-de-icone-de-aviao-de-ar_138676-278.jpg'} title={'Fazendo programa'} subtitle={'Testando descrição do programa'} />
                  <Card onClick={()=>navigate('/step')} image={'https://img.freepik.com/vetores-premium/ilustracao-de-icone-de-aviao-de-ar_138676-278.jpg'} title={'Fazendo programa'} subtitle={'Testando descrição do programa'} />
                </div>
